...
Email: darshna.chetwani@rejlers.ae
Password: Darshna@123
"""
...
def create_super_admin():
    ...
    email = "darshna.chetwani@rejlers.ae"
    username = "darshna.chetwani"
    password = "Darshna@123"
    
    print("=" * 60)
    print("AIFlow Super Admin Setup - Darshna Chetwani")
    print("=" * 60)
    ...
    try:
        ...
        if created:
            ...
            user.first_name = 'Darshna'
            user.last_name = 'Chetwani'
            user.is_staff = True
